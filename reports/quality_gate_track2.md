...
| Compliance | `compliance/*ComplianceChecker` in compose env | PCI-DSS 90/100, RBI 83/100 (passing), EU AI Act 100/100 — see `COMPLIANCE_DELTA_TRACK2.md` |
...
| `chargeback/narrative_generator.py` | 90% | LLM/fallback/parse paths |
