...
**Expected output:** `risk_tier: HIGH`, `return_risk_score ≈ 0.98`,
...
**Expected output:** `U_RING_001..003 → LOW 0.1157`; `U_RING_004 → HIGH 0.85`
...
- **Honesty:** the live demo runs the evaluated Stage 1 model on Stage 1
  features; the remaining calibration gap is documented, not hidden
