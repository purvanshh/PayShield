...
Current model: **v1.1.0** (2026-08-15) — 3-layer HeteroConv + GraphSAGE, hidden 128, dropout 0.3, target-user readout with transaction attention.

| Metric | GNN v1.1.0 | GNN v1.0.0 | Edge-free MLP | Lift vs MLP |
|--------|-----------|-----------|---------------|-------------|
| PR-AUC (lead) | 0.4125 | 0.198 | 0.1028 | 4.0× |
| AUC-ROC | 0.7668 | 0.692 | 0.5395 | +0.23 |
| FPR @ 90% recall | 0.4877 | 0.71 | 0.8196 | −0.33 |
| Inference (CPU, per ego-graph) | p50 0.60 ms / p99 0.70 ms | p50 1.0 / p99 2.5 ms | — | — |
| Parameters | 371,843 | 53,826 | — | — |

Source: `models/gnn_benchmark_results.json`, generated by `scripts/benchmark_gnn.py` (delta vs. the archived v1.0 baseline in `models/gnn_benchmark_delta.md`).
