...
|------|-----------|-----------|--------|----------|
| 0.30 | 68.8% | 0.530 | 0.922 | Aggressive review — catches most returns, more wrong flags |
| 0.40 | 58.6% | 0.589 | 0.871 | — |
| 0.45 | 54.4% | 0.619 | 0.850 | — |
| **0.50** | **49.9%** | **0.644** | **0.812** | **Review gate: flag for manual review (₹200 per wrong flag)** |
| 0.60 | 42.6% | 0.695 | 0.748 | — |
| 0.70 | 34.5% | 0.748 | 0.651 | Prepaid gate: block at checkout (₹3,180 per wrong block) |
...
```
Flagged (recall)          1,461 orders
  wrong flags              520 orders (35.6% of flagged, = 1 − precision)
  true catches              941 orders
Returns prevented          659 orders (70% diversion effectiveness)
Remaining returns        1,141 orders
Wrong-flag cost          520 × ₹200 = ₹1,04,000   (review, not full order!)
Return cost on remaining 1,141 × ₹2,795 = ₹31,89,095
Total with PayShield        ₹32,93,095 / month
Net savings                 ₹17,37,905 / month   (34.5% ROI)
Annual savings              ₹2,08,54,860 (~₹2.09 Cr)
```

Per **1,000 orders**: baseline ₹5,03,100 → with PayShield ₹3,29,310 →
**net savings ₹1,73,791**.
...
|----------|-----|-------------|-------------------------------|-----------------|----------------|-----|
| Fashion | ₹2,500 | 18% | ₹2,795 / ₹200 | **₹17,37,905** | ₹2.09 Cr | 34.5% |
| Electronics | ₹8,000 | 12% | ₹8,520 / ₹200 | **₹36,79,600** | ₹4.42 Cr | 36.0% |
| Grocery | ₹800 | 4% | ₹961 / ₹200 | **₹1,07,496** | ₹12.9 L | 28.0% |

Electronics shows the leverage of high AOV: each prevented return is worth
₹8.5k, so even a 12% return rate yields ~₹36.8L/month. Grocery shows the
...
|-----|-------------|-----------------|----------------|-----|
| ₹1,500 | 12% | ₹7,11,800 | ₹85.4 L | 33.4% |
| ₹2,500 | 18% | ₹17,37,905 | ₹2.09 Cr | 34.5% |
| ₹4,000 | 25% | ₹38,17,300 | ₹4.58 Cr | 35.3% |
...
|---|---|---|---|---|
| Fashion (high return) | 32% | 0.60 | **+₹24.0L** | **+₹24.2L** |
| Fashion (low return) | 14% | 0.60 | +₹3.3L | +₹3.5L |
| Electronics | 8% | 0.70 | +₹0.5L | +₹0.7L |
...
1. **64.4% precision at 0.50** — the wrong-flag cost is ₹200 of operator
   review time (the order still ships), not the ₹3,180 full-order loss. Even
   with ~36% wrong flags, review stays cheap relative to the returns it
   prevents.
2. **81.2% recall** — catches most of the high-return tail while flagging
   ~50% of orders; higher precision than the 0.30 gate, which flags 69% of
...
gate sweep above: ₹17.4L at 0.50 vs ₹15.6L at 0.30 and ₹16.6L at 0.70).
