...
- Verified score: **0.94 · HIGH** (live-features model — the contribution
  ...
  - confidence ≈ 0.92 (full history, all features real-data-sourced)
- Demo line: *"the merchant sees 0.94 with five auditable nudges — and the
...
- Verified score: **0.03 · LOW** (live-features model; only `R-RULE-08`
  ACCEPT rule fires)
...
- Verified (live, `shipping_address.pincode = 560037`):
  `U_RING_001..003` → **LOW 0.113**, `U_RING_004` → **HIGH 0.85** with
